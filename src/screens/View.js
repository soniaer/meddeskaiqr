...
<td style={{borderRight:"2px solid #d1d5db",borderTop:"none"}}>{item?.Barcode_Number}</td>
<td style={{borderRight:"2px solid #d1d5db",borderTop:"none"}}>{item?.Data_Sheet}</td>
<td style={{borderRight:"2px solid #d1d5db",borderTop:"none"}}>{item?.Product_Image}</td>
